...
const Body = () => {
  ...
  return allRestaurants?.length === 0 ? (
    ...
    <>
      <div className="bg-orange-500 my-5 p-5">
        <input
          type="text"
          className="p-2 m-2 focus:bg-green-100 rounded"
          placeholder="Search"
          value={searchText}
          onChange={(e) => {
        ...
        />
        <button
          className="bg-green-500 hover:bg-green-700 text-white p-1 rounded-md ml-5"
          onClick={() => {
